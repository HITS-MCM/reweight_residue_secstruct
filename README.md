...
- [x] to create the input files for `reweight_residue_secstruct.py` from Amber GaMD output files 
- [x] to run `reweight_residue_secstruct.py` with the generated input files.
