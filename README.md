...
To run `reweight_residue_secstruct.py`, please first create the necessary "environment", either by creating
...
> * The script `reweight_residue_secstruct.bsh` checks for standard Amber amino acid three-letter codes. 
